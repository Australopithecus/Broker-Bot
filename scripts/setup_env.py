...
def main() -> None:
    ...
    content = "\n".join(
        [
            ...
            f"ALPACA_LLM_PAPER_URL={paper_url}",
            f"ALPACA_LLM_DATA_FEED={data_feed}",
            "ALPACA_STAT_ARB_API_KEY=",
            "ALPACA_STAT_ARB_SECRET_KEY=",
            f"ALPACA_STAT_ARB_PAPER_URL={paper_url}",
            f"ALPACA_STAT_ARB_DATA_FEED={data_feed}",
            "ALPACA_AI_LAB_API_KEY=",
            "ALPACA_AI_LAB_SECRET_KEY=",
            f"ALPACA_AI_LAB_PAPER_URL={paper_url}",
            f"ALPACA_AI_LAB_DATA_FEED={data_feed}",
            "",
            ...
            "MEMORY_WEIGHT=0.8",
            "LLM_WEIGHT=0.8",
            "STAT_ARB_LOOKBACK_DAYS=180",
            "STAT_ARB_SYMBOL_LIMIT=80",
            "STAT_ARB_MIN_CORRELATION=0.72",
            "STAT_ARB_ENTRY_Z=1.25",
            "STAT_ARB_EXIT_Z=0.35",
            "STAT_ARB_MAX_PAIRS=5",
            "STAT_ARB_PAIR_GROSS_PCT=0.08",
            "AI_LAB_LOOKBACK_DAYS=260",
            "AI_LAB_SYMBOL_LIMIT=180",
            "AI_LAB_MAX_LONG_POSITIONS=10",
            "AI_LAB_MAX_SHORT_POSITIONS=6",
            "AI_LAB_MIN_ABS_SCORE=0.006",
            "AI_LAB_EXPLORATION_RATE=0.10",
            "EXECUTION_ORDER_MODE=simple",
            "BRACKET_TAKE_PROFIT_PCT=0.04",
            "BRACKET_STOP_LOSS_PCT=0.02",
            "TRAILING_STOP_ENABLED=0",
            "TRAILING_STOP_PERCENT=0.0",
            "TRAILING_STOP_PRICE=0.0",
            "TRAILING_STOP_TIF=gtc",
            "OPTIONS_MIN_DTE=14",
            "OPTIONS_MAX_DTE=45",
            "OPTIONS_IDEA_LIMIT=6",
            "OPTIONS_SPREAD_WIDTH_PCT=0.05",
            "LLM_ENABLED=0",
