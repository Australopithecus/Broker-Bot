    ...
    "changelog": [
        {
            "revision": "2.7.3",
            "date": "2026-04-30",
            "title": "Detailed table disclosure fix",
            "changes": [
                "Replaced nested Streamlit report-body expanders with toggles inside Detailed bot tables.",
                "Prevented the Detailed Tables section from throwing a Streamlit nested-expander error.",
            ],
        },
        {
            "revision": "2.7.2",
            "date": "2026-04-30",
            "title": "Seven-day default trend window",
            "changes": [
                "Changed the dashboard trend graph default window from 14 days to 7 days.",
                "Kept longer graph windows available for historical review.",
            ],
        },
        {
            "revision": "2.7.1",
            "date": "2026-04-30",
            "title": "Unified trend cutoff",
            "changes": [
                "Changed the dashboard trend graph so ML Bot, LLM Bot, and SPY all hide data before April 23, 2026.",
                "Updated graph helper text to make the shared cutoff explicit.",
            ],
        },
        {
            "revision": "2.7.0",
